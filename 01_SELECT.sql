 ...
 * 
 * - RESULT SET은 0개 이사의 행을 포함할 수 있다.
...
--> " " 쌍따옴표 특수문자, 대소문자, 기호 등을 구분하여 나타낼 때 사용하는 표기법
...
-- EMPLPYEE 테이블에서 급여가 300만 미만 또는 500만 이상인 사원의
-- 사번, 이름, 급여, 전화번호 조회
...
-- EMPLPYEE 테이블에서 급여가 300만 이상 또는 500만 미만인 사원의
-- 사번, 이름, 급여, 전화번호 조회
...
SELECT EMP_ID, EMP_NAME, DEPT_CODE
FROM EMPLOYEE
WHERE DEPT_CODE NOT IN('D1', 'D2', 'D9') -- 12명

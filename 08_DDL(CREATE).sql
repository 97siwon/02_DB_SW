...
-- TCL(TRANSACTION CONTROL LANGUGE) : 트랜잭션 제어 언어
...
CREATE TABLE "MEMBER"(
	...
	MEMBER_SSN CHAR(14),-- 991213-124567
...
-- 문자인코딩 UTF-8 영어, 숫자 1BITE, 한글, 특수문자 등은 3BYTE 취급
...
-- 추가 샘플 데이터 삽입
-- 가입일 -> SYSDATE를 활용
INSERT INTO "MEMBER" VALUES('MEM02', '456ABC', '홍길순', 
                        '991213-1654321', SYSDATE);

-- 가입일 -> DEFAULT 활용(테이블 생성 시 정의된 값이 반영됨)
INSERT INTO "MEMBER" VALUES('MEM03', '789ABC', '홍길리', 
                        '951216-1954223', DEFAULT);

-- 가입일 -> INSERT 시 미작성 하는 경우 -> DEAFULT 값이 반영됨
-- INSERT INTO 테이블명(컬럼명1, 컬럼명2, 컬럼명3) 
-- VALUES(값1, 값2, 값3);
                       
INSERT INTO "MEMBER" (MEMBER_ID, MEMBRT_PWD, MEMBER_NAME)
VALUES('MEM4', 'SDF456', '이지연');

-- ** JDBC에서 날짜를 입력받았을 때 삽입하는 방법 **
-- '2022-09-13 17:33:27'
INSERT INTO "MEMBER" VALUES('MEM05', 'PASD4546', '김갈올', '980505-1234567',
...
INSERT INTO MEMBER2 VALUES('MEM02', 'PASS02', '고길손', '01020608040');
...
-- ORA-01400: NULL을 ("KH_LSW"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
--  ORA-00001: 무결성 제약 조건(KH_LSW.USER_ID_U)에 위배됩니다
...
-- ORA-00001: 무결성 제약 조건(KH_LSW.USER_ID_NAME_U)에 위배됩니다
...
--> 기본키 중복으로 오류
-- ORA-00001: 무결성 제약 조건(KH_LSW.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK
VALUES(NULL, 'user03', 'pass03', '유관순', '여', '010-9999-3131', 'yoo123@kh.or.kr');
--> 기본키가 NULL 이므로 오류
-- ORA-01400: NULL을 ("KH_LSW"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
...
-- ORA-00001: 무결성 제약 조건(KH_LSW.PK_USERNO_USERID)에 위배됩니다
...
-- ORA-01400: NULL을 ("KH_LSW"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다
...
-- ORA-02290: 체크 제약조건(KH_LSW.GENDER_CHECK)이 위배되었습니다
